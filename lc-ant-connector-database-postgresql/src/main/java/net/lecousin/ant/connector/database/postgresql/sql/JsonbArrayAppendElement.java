...
public class JsonbArrayAppendElement extends AbstractExpression {

	private final Column jsonbArrayColumn;
	private final Expression appendValue;
	
	public JsonbArrayAppendElement(Column jsonbArrayColumn, Expression appendValue, RenderContext renderContext) {
		super(renderContext);
	...
	protected List<Object> getElementsToRender() {
		return List.of(jsonbArrayColumn, " || jsonb_build_array(", appendValue, ")");
	}
